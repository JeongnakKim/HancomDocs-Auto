...
'닉네임 영역'
WebUI.verifyElementText(findTestObject('Object Repository/HD_Luncher/Text/accuont_nickname_txt'), '자동화테스트 PRD 2번', FailureHandling.CONTINUE_ON_FAILURE)

'이메일 영역'
WebUI.verifyElementText(findTestObject('Object Repository/HD_Luncher/Text/account_email_txt'), 'hcnewbiz+prdat2@gmail.com', 
    FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.click(findTestObject('HD_Luncher/Profile_icon_subscribe'), FailureHandling.CONTINUE_ON_FAILURE)
...
'닉네임 영역'
WebUI.verifyElementText(findTestObject('Object Repository/HD_Luncher/Text/accuont_nickname_txt'), '자동화테스트 PRD 1번', FailureHandling.CONTINUE_ON_FAILURE)

'이메일 영역'
WebUI.verifyElementText(findTestObject('Object Repository/HD_Luncher/Text/account_email_txt'), 'hcnewbiz+prdat1@gmail.com', 
    FailureHandling.CONTINUE_ON_FAILURE)
...
WebUI.setText(findTestObject('Object Repository/HD_Landing/Login_input__email'), 'hcnewbiz+prdat3@gmail.com', FailureHandling.CONTINUE_ON_FAILURE)
...
'닉네임 영역'
WebUI.verifyElementText(findTestObject('Object Repository/HD_Luncher/Text/accuont_nickname_txt'), '자동화테스트 PRD 3번', FailureHandling.CONTINUE_ON_FAILURE)

'이메일 영역'
WebUI.verifyElementText(findTestObject('Object Repository/HD_Luncher/Text/account_email_txt'), 'hcnewbiz+prdat3@gmail.com', 
    FailureHandling.CONTINUE_ON_FAILURE)
